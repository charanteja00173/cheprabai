  ...
  return extendTheme({
    ...
    components: {
      ...
      Heading: {
        ...
        sizes: {
          "4xl": { fontSize: "clamp(2rem, 1.5rem + 2.5vw, 3.5rem)" },
          "3xl": { fontSize: "clamp(1.75rem, 1.3rem + 2vw, 3rem)" },
          "2xl": { fontSize: "clamp(1.5rem, 1.15rem + 1.5vw, 2.25rem)" },
          xl: { fontSize: "clamp(1.25rem, 1rem + 1vw, 1.75rem)" },
          lg: { fontSize: "clamp(1.1rem, 0.95rem + 0.6vw, 1.5rem)" },
          md: { fontSize: "clamp(0.95rem, 0.85rem + 0.4vw, 1.25rem)" },
          sm: { fontSize: "clamp(0.85rem, 0.8rem + 0.2vw, 1rem)" },
          xs: { fontSize: "clamp(0.75rem, 0.72rem + 0.15vw, 0.875rem)" },
        },
      },
      Text: {
